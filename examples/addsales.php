            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Add Sales</a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="../assets/code/insertsales.php">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Date</label>
                                                <input type="date" name="date" required id="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-5 pr-1 py-5">
                                            <div class="form-group">
                                                <label>Quantity</label>
                                                <input type="number" required class="form-control" placeholder="Quantity" name="quantity">
                                            </div>
                                        </div>
                                        <div class="col-md-5 pr-1 py-5">
                                            <div class="form-group">
                                                <label>Customer Name</label>
                                                <input type="text" required class="form-control" placeholder="Customer Name : " name="customer">
                                            </div>
                                        </div>
                                        <div class="formsubmit col-md-5 py-5">
                                            <div class="form-group">
                                                <input type="submit" class="form-control" value="Add Sale" tabindex="3">
                                            </div>
                                        </div>
                                </form>
                            </div>
