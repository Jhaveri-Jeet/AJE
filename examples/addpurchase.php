            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Add Purchase</a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="../assets/code/insertpurchase.php">
                                    <div class="row">
                                        ...
                                        <div class="formsubmit col-md-5 py-5">
                                            <div class="form-group">
                                                <input type="submit" class="form-control" value="Add Purchase" tabindex="3">
                                            </div>
                                        </div>
                                </form>
                            </div>
